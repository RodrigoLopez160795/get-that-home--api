...
photolist=[{io: File.open('app/assets/images/image1.jpg'), filename: 'image1.jpg'},{io: File.open('app/assets/images/image1.jpg'), filename: 'image1.jpg'}]
#property1.photos.attach(photolist)
property1.photos.attach(io: File.open('app/assets/images/image1.jpg'), filename: 'image1.jpg')
puts property1.photos.size